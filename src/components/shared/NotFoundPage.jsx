  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[rgb(var(--bg))] px-6 py-12 overflow-hidden relative select-none">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          className="absolute top-[10%] left-[15%] w-80 h-80 rounded-full bg-purple-500/6 blur-[100px]"
      ...
      >
        ...
        <motion.div variants={fadeUp} className="relative inline-block">
          <motion.h1
            className="text-[7rem] sm:text-[9rem] font-black tracking-tighter leading-none bg-gradient-to-br from-[rgb(var(--text))] via-purple-500 to-blue-500 bg-clip-text text-transparent"
