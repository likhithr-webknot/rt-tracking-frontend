...
export default function KPIRegistry({ kpis, searchQuery, setSearchQuery, onAddKpi }) {
              ...
              <tr key={kpi.id} className="hover:bg-white/[0.01] transition-colors group">
                ...
                <td className="p-6 text-right px-8">
                  <div className="flex justify-end gap-2">
                    <button className="p-2.5 bg-blue-500/5 text-blue-500 hover:bg-blue-500 hover:text-white rounded-xl transition-all border border-blue-500/10">
                      <Edit3 size={18} />
                    </button>
